...
impl From<DropsetError> for &'static str {
    fn from(value: DropsetError) -> Self {
        match value {
            ...
            DropsetError::NoFreeSectorsRemaining => "There are no free stack sectors left",
            ...
            DropsetError::NumSectorsCannotBeZero => "Number of sectors can't be zero",
