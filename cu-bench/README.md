...
program with `pnpm run build && pnpm run deploy` at commit [f7d08fc],
which builds the program with the `--arch v2` flag.
...
----------------------------------------------------------------------------
     10      3.32        3 - 4         12 - 16          62 - 66
    100      6.64        6 - 7         24 - 28          74 - 78
   1000      9.97         10             40                90
```
